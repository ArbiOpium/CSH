...
namespace csharp_all.Data
{
    ...
    internal class DataAccessor
    {
        ...
        public DataAccessor()
        {
            String dbPath = @"c:\Users\Yaroslav\Desktop\csharp-all-master\ShopDB.mdf";
        ...
        {
            String connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Yaroslav\Downloads\csharp-all\ShopDB.mdf;Integrated Security=True";
            using SqlConnection conn = new(connectionString);
            conn.Open();
            String sql = $@"CREATE DATABASE ShopDB ON PRIMARY (NAME=ShopDB_data, FILENAME='{filename}')";
        ...
        public IEnumerable<ProdSaleModel> Top3DailyProducts(CompareMode compareMode)
        {
            ...
            if (compareMode == CompareMode.ByQuantity)
            {
                sql = @$"
                    ...
                    FROM
	                    ShopSales S
	                    JOIN ShopProducts P ON S.ProductId = P.Id
                    WHERE
        ...
        {
            return ExecuteScalar<Product>("SELECT TOP 1 * FROM ShopProducts ORDER BY NEWID()");
        }
        public Department RandomDepartment()
        {
            return ExecuteScalar<Department>("SELECT TOP 1 * FROM ShopDepartments ORDER BY NEWID()");
        }
        public Manager RandomManager()
        {
            return ExecuteScalar<Manager>("SELECT TOP 1 * FROM ShopManagers ORDER BY NEWID()");
        }

        public List<Product> GetProducts()
        {
            return ExecuteList<Product>("SELECT * FROM ShopProducts");
        }
        public List<Department> GetDepartments()
        {
            return ExecuteList<Department>("SELECT * FROM ShopDepartments");
        }
        public List<Manager> GetManagers()
        {
            return ExecuteList<Manager>("SELECT * FROM ShopManagers");
        }
        public List<News> GetNews()
        {
            return ExecuteList<News>("SELECT * FROM ShopNews");
        }
        ...
        {
            String sql = "SELECT * FROM ShopDepartments";
            using SqlCommand cmd = new(sql, connection);
        ...
        {
            String sql = "SELECT * FROM ShopManagers";
            using SqlCommand cmd = new(sql, connection);
            SqlDataReader? reader;
            try
            {
        ...
        {
            String sql = "SELECT * FROM ShopProducts";
            using SqlCommand cmd = new(sql, connection);
            SqlDataReader? reader;
            try
            {
        ...
        {
            String sql = "CREATE TABLE ShopSales(" +
        ...
        {
            String sql = "CREATE TABLE ShopManagers(" +
                "Id           UNIQUEIDENTIFIER PRIMARY KEY," +
        ...
        {
            String sql = "CREATE TABLE ShopDepartments(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
                "Name  NVARCHAR(64)     NOT NULL)";
            using SqlCommand cmd = new(sql, connection);
            try
        ...
        {
            String sql = "CREATE TABLE ShopProducts(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
                "Name  NVARCHAR(64)     NOT NULL," +
        ...
        {
            String sql = "CREATE TABLE ShopNews(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
        ...
        {
            String sql = "CREATE TABLE ShopAccess(" +
                "Id    UNIQUEIDENTIFIER PRIMARY KEY," +
                "ManagerId    UNIQUEIDENTIFIER NOT NULL," +
        ...
        {
            String sql = "INSERT INTO ShopProducts VALUES" +
        ...
        {
            String sql = "INSERT INTO ShopManagers VALUES" +
        ...
        {
            String sql = "INSERT INTO ShopDepartments VALUES" +
        ...
        {
            String sql = "INSERT INTO ShopNews VALUES" +
        ...
        {
            String sql = "INSERT INTO ShopAccess VALUES" +
        ...
        {
            String sql = "INSERT INTO ShopSales(Id, ManagerId, ProductId, Quantity, Moment) VALUES" +
                "( NEWID(), " +
                " (SELECT TOP 1 Id FROM ShopManagers ORDER BY NEWID()), " +
                " (SELECT TOP 1 Id FROM ShopProducts ORDER BY NEWID()), " +
        ...
        {
            String sql = $"SELECT COUNT(*) FROM ShopSales WHERE Moment BETWEEN @date AND DATEADD(MONTH, 1, @date)";
            using SqlCommand cmd = new(sql, connection);
